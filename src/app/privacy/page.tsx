      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Karaoke Match.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Karaoke Match, accessible from{' '}
            <a href="https://karaoke.karl.run" rel="external nofollow noopener" target="_blank">
              karaoke.karl.run
            </a>
          </p>
        </li>
